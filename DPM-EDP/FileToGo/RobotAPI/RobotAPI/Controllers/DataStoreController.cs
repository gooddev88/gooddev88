...
namespace RobotAPI.Controllers {
    ...
    public class DataStoreController : ControllerBase {
        ...
        public DataStoreController(DataStoreContext _dataStoreContext, ConfigurationManager _configuration) {
        ...
        public async Task<AccidentDataSet> GetAccidentAll()
        {
            ...
            try
            {
                data = dataStoreContext.accident_data.ToList();
        ...
        public async Task<List<accident_data>> DataStore() {
            ...
            try {
                data = dataStoreContext.accident_data.Where(o => o.accident_date <= being && o.accident_date >= end).ToList();
