    ...
    public class LogInService {
        ...
        public static LoginSet Login(string username, string password, string appid, string rcom = "") {
            ...
            try {
                using (GAEntities db = new GAEntities()) {
                    ...
                    loginInfo.CurrentCompany = db.CompanyInfo.Where(o => o.CompanyID == first_com && o.RCompanyID == rcom).FirstOrDefault();
        ...
        public static List<vw_PermissionInMenu> ListUserInMenuDisplay(List<vw_PermissionInMenu> input) {
            ...
            try {
                ...
                result = input.Where(o => o.IsOpen == true).GroupBy(x => new { x.Username, x.MenuID, x.GroupID, x.TypeID, x.MenuName, x.MenuDesc1, x.MenuDesc2, x.Url, x.Icon, x.GroupSort,x.AppID })
