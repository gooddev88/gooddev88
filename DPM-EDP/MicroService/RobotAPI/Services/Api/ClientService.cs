...
namespace RobotAPI.Services.Api {
    public class ClientService {
      
            private readonly HttpClient httpClient;
            private readonly IConfiguration config; 
            public ClientService(IConfiguration _config ) {
            ...
            public async Task<ResponseMessage> Post<T>(string dataEndpointUri,string     token, object values) {
                try {
        ...
        public async Task<ResponseMessage> GetAllStringAsync<T>(string dataEndpointUri, string token) {
            //IEnumerable<T> result = default;
            var res = new ResponseMessage();
            try {
                ...
                if (response.StatusCode.ToString() == "Unauthorized") {
                    ...
                    var result = JsonConvert.DeserializeObject<T>(Result);
        ...
        //public async Task<ResponseMessage> GetAllStringgAsync<T>(string dataEndpointUri) {
        //    //IEnumerable<T> result = default;
        //    var res = new ResponseMessage();
        //    try {
        //        var str_res = await httpClient.GetStringAsync(dataEndpointUri);
        //     //   str_res = str_res.Replace("\r\n", "");
        //       var x =System.Text.Json.JsonSerializer.Deserialize<List<WarningPublish>>(str_res);
