...
namespace RobotWasm.Server.Data.DA.Stock {
    public class StockBalanceService {
        ...
        public static List<vw_OSOLine> PrintStockBal(vw_OSOLine l) {
            List<vw_OSOLine> result = new List<vw_OSOLine>();
            using (GAEntities db = new GAEntities()) {
                result = db.vw_OSOLine.Where(o => o.OrdID == l.OrdID).OrderBy(o => o.LineNum).ToList();
