...
namespace Robot.Controllers.Promotion {
    [Route("api/promotion/[controller]")]
    [ApiController]
    public class PromotionController : Controller {

        private readonly IWebHostEnvironment _hostingEnvironment;
        public PromotionController(IWebHostEnvironment hostingEnvironment) {
        ...
        [HttpGet("DownloadItemPromotion/{rcom}/{com}")]
        public ActionResult DownloadItemPromotion(string rcom,string com) {
            try {
                string filename = "ItemsPromotion-" + DateTime.Now.Year.ToString("0000") + DateTime.Now.Month.ToString("00") + DateTime.Now.Day.ToString("00")+".xlsx";
                var stream = PromotionService.DownItemToExcel(rcom, com);
