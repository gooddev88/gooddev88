...
namespace Robot.Data.DA.Master
{
    ...
    {
        public static string sessionActiveId = "activeotaxid";
        #region Class
        ...
        //            }
        //            SelectListTax blank = new SelectListTax { TaxID = "", TaxName = "", Description = "", TaxValue = 0, Sort = 0, IsActive = true };
        //            result.Add(blank);
        ...
        public static List<SelectListTax> MiniSelectListV2(string type, bool needBlank) {
            //type = PURCHASE || SALE
            List<SelectListTax> result = new List<SelectListTax>();
            using (GAEntities db = new GAEntities()) {
                ...
                if (needBlank) {
                    SelectListTax blank = new SelectListTax { TaxTypeID = "", TaxName = "", Description = "", TaxValue = 0, Sort = 0, IsActive = true };
        ...
        public static TaxInfo GetTaxInfoByTaxID(string TaxID)
        {

            TaxInfo result = new TaxInfo();
            using (GAEntities db = new GAEntities())
            {
                result = db.TaxInfo.Where(o => o.TaxTypeID == TaxID).OrderBy(o => o.Sort).FirstOrDefault();
            }
            return result;
        }
