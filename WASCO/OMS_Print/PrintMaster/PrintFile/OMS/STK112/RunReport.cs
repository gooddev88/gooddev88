...
namespace PrintMaster.PrintFile.OMS.STK112 {
    public class RunReport {
        ...
        public static STK112 OpenReport(PrintData print_row, string isExport="0") { 
            var doc = JsonConvert.DeserializeObject<STK112Set>(print_row.JsonData);
            STK112 report0 = new STK112(doc);
        ...
        public class vw_ItemInfoWithPhotoAndStock {
