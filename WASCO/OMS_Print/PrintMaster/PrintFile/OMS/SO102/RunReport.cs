...
namespace PrintMaster.PrintFile.OMS.SO102 {
    public class RunReport {
        ...
        public static SO102 OpenReport(PrintData print_row, string isExport="0") { 
            var doc = JsonConvert.DeserializeObject<SO102Set>(print_row.JsonData); 
            SO102 report0 = new SO102(doc, "0");
            report0.DisplayName = doc.Head.OrdID;
            report0.CreateDocument();
            //SO102 report1 = new SO102(doc, "1");
