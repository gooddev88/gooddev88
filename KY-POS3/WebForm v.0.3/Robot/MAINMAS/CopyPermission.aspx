<%@ Page Title="Copy menu" Language="C#" MasterPageFile="~/MainE.Master" AutoEventWireup="true" CodeBehind="CopyPermission.aspx.cs" ClientIDMode="Static" Inherits="Robot.MAINMAS.CopyPermission" %>
                        ...
                        <div class="card-body bg-light">
                            <div class="row pb-3  kanit " runat="server" id="divroleUser">
                                <div class="col-md-12 kanit">
                                    <asp:ObjectDataSource ID="roleUserdatasource" runat="server" SelectMethod="LoadRoleUser" TypeName="Robot.MAINMAS.CopyPermission">
                                           <SelectParameters>
                            ...
                            <div class="row pb-3  kanit " runat="server" id="divRoleGroup">
                                <div class="col-md-12 kanit">
                                    <asp:ObjectDataSource ID="roleGroupdatasource" runat="server" SelectMethod="LoadRoleGroup" TypeName="Robot.MAINMAS.CopyPermission" OldValuesParameterFormatString="original_{0}">
                                        <SelectParameters>
                                            <asp:SessionParameter Name="fromGroup" SessionField="fromroleid" Type="String" />
                                        </SelectParameters>
                                    </asp:ObjectDataSource>
