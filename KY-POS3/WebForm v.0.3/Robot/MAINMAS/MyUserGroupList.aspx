<%@ Page Title="User Group" Language="C#" EnableEventValidation="false" MasterPageFile="~/MAINMAS/SiteA.Master" AutoEventWireup="true" CodeBehind="MyUserGroupList.aspx.cs" Inherits="Robot.MAINMAS.MyUserGroupList" %>
                ...
                <div class="card-body bg-light pt-1 pb-1"> 
                            <div class="row "> 
                                ...
                                <div class="col-md-4 pt-4 text-right">
                                    <asp:CheckBox ID="chkShowDisable"  Text="แสดงที่ยกเลิกด้วย" runat="server"
                    ...
                    <PanelCollection>
                        <dx:PanelContent>
                                ...
                                <dx:ASPxGridView ID="grdDetail" runat="server"
                                    ...
                                    <Columns>
                                        <dx:GridViewDataTextColumn  Width="60"  Caption=""  >
                                            <DataItemTemplate>
                                        ...
                                        <dx:GridViewDataTextColumn Caption="รหัสกลุ่ม" FieldName="UserGroupID" Width="160">
                                            <Settings AutoFilterCondition="Contains" />
                                            <HeaderStyle  Wrap="False"  CssClass="Sarabun" />
                                            <CellStyle  Wrap="False" Font-Size="Smaller"  CssClass="Sarabun" />
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="ชื่อกลุ่ม" FieldName="GroupName"    >
                                            <Settings AutoFilterCondition="Contains" />
                                            <HeaderStyle  Wrap="False" CssClass="Sarabun" />
                                            <CellStyle  Wrap="False" Font-Size="Smaller"  CssClass="Sarabun" />
                                        </dx:GridViewDataTextColumn>
                                               <dx:GridViewDataTextColumn Caption="การจัดเรียง" FieldName="Sort" Width="60">
                                            <HeaderStyle  Wrap="False"  CssClass="Sarabun" />
                                            <CellStyle  Wrap="False" Font-Size="Smaller"  CssClass="Sarabun" />
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataCheckColumn Caption="ใช้งาน" FieldName="IsActive" Width="60">
                                            <HeaderStyle  Wrap="False"  CssClass="Sarabun" />
