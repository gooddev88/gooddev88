...
namespace Robot.Data.DataAccess {
    public static class CurrencyInfoService {
        ...
        //public static decimal GetExchangeRate(string currencyid ,string ratetype, DateTime currdate) {
        //    decimal result =1;
        //    using (GAEntities db = new GAEntities()) {
        //        var curr = db.ExchangeRate.Where(o => o.Currency==currencyid && o.RateType== ratetype && o.RateDate<=currdate).OrderByDescending(o=>o.RateDate) .FirstOrDefault();
        //        if (curr != null) {
        //            result = curr.Rate;
        //        }  
        //    }
