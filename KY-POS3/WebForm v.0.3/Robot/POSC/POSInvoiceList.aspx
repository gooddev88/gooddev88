<%@ Page Title="ประวัติขาย" Language="C#" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" MasterPageFile="~/POSC/SiteA.Master" AutoEventWireup="true" CodeBehind="POSInvoiceList.aspx.cs" Inherits="Robot.POSC.POSInvoiceList" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header pt-1 pb-1">
                                    <div class="row ">
                                        <div class="col-md-8"><i class="fa fa-filter"></i>&nbsp<span ><%=hddTopic.Value %></span></div>
                                        ...
                                        <i class="fa fa-plus"></i>&nbsp<span >ขาย</span> 
                                                </asp:LinkButton>
                                            </div>
                                        </div>
                                    </div>
  ...
  <div class="col-md-2 text-right pt-4"> 
      <asp:CheckBox ID="chkShowCancel" Text="Show Cancel bill"  runat="server" AutoPostBack="true" OnCheckedChanged="cchkShowCancel_CheckedChanged" />
     </div>
                                                    </div>
