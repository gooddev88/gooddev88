<%@ Page Title="MyUser" Language="C#" EnableEventValidation="false" MasterPageFile="~/POS/SiteA.Master" AutoEventWireup="true" CodeBehind="MyUserList.aspx.cs" Inherits="Robot.Master.MyUserList" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
                ...
                <PanelCollection>
                    <dx:PanelContent>
                            ...
                            <dx:ASPxGridView ID="grdDetail" runat="server"
                                ...
                                <Columns>
                                    <dx:GridViewDataTextColumn  Caption="OPEN" Width="60">
                                        <DataItemTemplate>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Employee code" FieldName="EmpCode">
                                        <HeaderStyle  Wrap="False" />
                                        <CellStyle  Wrap="False" />
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Department" FieldName="DepartmentID" Visible="false">
                                        ...
                                        <dx:GridViewDataTextColumn Caption="Default Branch" FieldName="DefaultCompany" >
                                        <HeaderStyle  Wrap="False" />
                                        <CellStyle  Wrap="False" />
                                    </dx:GridViewDataTextColumn>
    ...
    <dx:GridViewDataCheckColumn Caption="สามารถใช้โปรแกรม" FieldName="IsProgramUser" Width="60">
                                        <HeaderStyle  Wrap="False" />
