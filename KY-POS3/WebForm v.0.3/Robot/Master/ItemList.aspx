<%@ Page Title="สินค้าและบริการ" Language="C#" EnableEventValidation="false" MasterPageFile="~/POS/SiteA.Master" AutoEventWireup="true" CodeBehind="ItemList.aspx.cs" Inherits="Robot.Master.ItemList" %>
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-center">
                            <asp:Label runat="server" Font-Size="XX-Large" Font-Bold="true"  ID="lblinfohead"></asp:Label>
                        </div>
                        <div class="col-md-4 text-right pb-2">
                                      <asp:LinkButton ID="btnSavePhoto" ForeColor="Black" CssClass="btn btn-info" runat="server" 
                                OnClick="btnSavePhoto_Click">
                                <i class="fas fa-sync-alt" style="color:white"></i>
                            </asp:LinkButton>
                            
		          <asp:LinkButton ID="btnCopyPrice" CssClass="btn btn-dark" runat="server" OnClick="btnCopyPrice_Click">   
                                <span >ก๊อปปี้ราคาสินค้าให้สาขาอื่น</span> 
                            </asp:LinkButton>
                    ...
                    <div  style="overflow-x: auto; width: 100%">
                        <dx:ASPxGridView ID="grdDetail" 
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="รหัสสินค้าและบริการ" FieldName="ItemID" Width="120">
                                    <HeaderStyle  Wrap="False" />
                                    <CellStyle  Wrap="False" />
                                </dx:GridViewDataTextColumn>
      <dx:GridViewDataTextColumn Caption="ประเภท" FieldName="TypeID" Width="130">
                                    <HeaderStyle  Wrap="False" />
                                    <CellStyle  Wrap="False" />
                                </dx:GridViewDataTextColumn>
                                ...
                                <dx:GridViewDataTextColumn Caption="รายละเอียด 1" FieldName="Name1" Width="100%">
                                    <HeaderStyle  Wrap="False" />
                                    <CellStyle  Wrap="False" />
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="รายละเอียด 2" FieldName="Name2" Width="300">
                                    <HeaderStyle  Wrap="False" />
                                    <CellStyle  Wrap="False" />
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Unit" FieldName="UnitID">
                                    <HeaderStyle  Wrap="False" />
                                    <CellStyle  Wrap="False" />
                                </dx:GridViewDataTextColumn>
