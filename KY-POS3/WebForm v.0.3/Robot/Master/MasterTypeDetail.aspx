<%@ Page Title="Option" Language="C#" MasterPageFile="~/POS/SiteA.Master" AutoEventWireup="true" CodeBehind="MasterTypeDetail.aspx.cs" Inherits="Robot.Master.MasterTypeDetail" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <script type="text/javascript">
        ...
        function OnClosePopupEventHandler(command) {
            switch (command) {
                case 'OK-Line':
                    popprofile.Hide();
                    btnClosePopUpMasterType.DoClick();
                    break;
                case 'Cancel':
                    popup.Hide();
                    popMessage.Hide();
    ...
    <dx:ASPxButton ID="btnClosePopUpMasterType" runat="server" ClientInstanceName="btnClosePopUpMasterType" ClientVisible="false"
        OnClick="btnClosePopUpMasterType_Click">
    </dx:ASPxButton>
