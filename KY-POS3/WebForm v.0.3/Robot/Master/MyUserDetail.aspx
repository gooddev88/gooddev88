<%@ Page Title="User & Permission" Language="C#"  MasterPageFile="~/POS/SiteA.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="MyUserDetail.aspx.cs" Inherits="Robot.Master.MyUserDetail" %>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="btn-group">
                                                <asp:CheckBox ID="chkIsNewUser" runat="server" AutoPostBack="true"  Text="ต้องเปลียนรหัสผ่านเมื่อ Login ครั้งต่อไป" OnCheckedChanged="chkIsNewUser_CheckedChanged" />
                                                <asp:CheckBox ID="chkIsProgramUser" runat="server" AutoPostBack="true"  Text="สามารถใช้โปรแกรม" OnCheckedChanged="chkIsProgramUser_CheckedChanged" />
                                                <asp:CheckBox ID="chkIsUseTimeStampt" runat="server" Visible="false" AutoPostBack="true"  Text="ออกรายงานบันทึกเวลา" OnCheckedChanged="chkIsUseTimeStampt_CheckedChanged" />
                                                                        ...
                                                                        <asp:GridView ID="grdUserInGroup" runat="server"
                                                                            ...
                                                                            <Columns>
                                                                                <asp:TemplateField HeaderText="" >
                                                                                    <ItemTemplate>
                                                                                        <asp:CheckBox ID="chkGroupSelect" runat="server" Checked='<%# Bind("IsInGroup") %>' />
                                                                                    </ItemTemplate>
                                                                        ...
                                                                        <asp:GridView ID="grdUserInCompany" runat="server" AutoGenerateColumns="False"
                                                                            ...
                                                                            <Columns>
                                                                                <asp:TemplateField HeaderText="Select">
                                                                                    ...
                                                                                    <ItemTemplate>
                                                                                        <asp:CheckBox ID="chkIsInCompany" runat="server" Checked='<%# Bind("IsInCompany") %>' />
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                    ...
                                                                    <div style="width: 100%; overflow: auto;">
                                                                        <asp:GridView ID="grdDashBoard" runat="server"
                                                                            ...
                                                                            <Columns>
                                                                                <asp:TemplateField HeaderText="">
                                                                                    <ItemTemplate>
                                                                                        <asp:CheckBox ID="chkIsInBoard" runat="server" Checked='<%# Bind("IsInBoard") %>' />
                                                                                    </ItemTemplate>
                                                                                    <HeaderStyle  Wrap="false" Width="60px" />
                                                                                </asp:TemplateField>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div id="grdCharges" runat="server" style="width: 100%; overflow: auto;">
                                                                        <asp:GridView ID="grdPermission" runat="server" AutoGenerateColumns="False"
                                                ...
                                                <div class="card">
                                                    <div class="card-header" style="background-color: cornflowerblue !important">
                                                        <a class="collapsed card-link" data-toggle="collapse" href="#collapseFour">
                                                            <span  style="color: black">Document Step</span>
                                                        </a>
                                                    </div>
                                                    <div id="collapseFour" class="collapse" data-parent="#accordion">
                                                        <div class="card-body bg-light">
                                                            <asp:UpdatePanel ID="udpdocStep" runat="server">
                                                                <ContentTemplate>
                                                                    <div class="row ">
                                                                        <asp:Label runat="server" class="col-md-2 ">Document Step</asp:Label>
                                                                        <div class="col-md-6 ">
                                                                            <asp:DropDownList ID="cboDocStep" runat="server" CssClass="form-control "
                                                                                DataTextField="FullDesc" DataValueField="StepID">
                                                                            </asp:DropDownList>
                                                                        </div>
                                                                        <div class="col-md-3 ">
                                                                            <asp:LinkButton ID="btnAddDocStep"
                                                                                runat="server" CssClass="btn btn-dark btn-sm"
                                                                                OnClick="btnAddDocStep_Click">
                                                                      <span style="color:red">  <i class="fas fa-plus-circle fa-2x"></i></span>
                                                                          &nbsp<span >++ADD NEW++</span> 
                                                                            </asp:LinkButton>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row pt-3">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12 ">
                                                                                    <div style="overflow-x: auto; width: 100%">
                                                                                        <asp:GridView ID="grdGroupInDoc" runat="server" AutoGenerateColumns="False" Width="100%"
                                                                                            CssClass="table table-striped table-bordered table-hover"
                                                                                            EmptyDataText="No record found.."
                                                                                            EmptyDataRowStyle-HorizontalAlign="Center"
                                                                                            ShowHeaderWhenEmpty="true"
                                                                                            Font-Size="Smaller"
                                                                                            OnRowCommand="grdGroupInDoc_RowCommand"
                                                                                            DataKeyNames="ID">
                                                                                            <Columns>
                                                                                                <asp:BoundField DataField="DocTypeID" HeaderText="Document type">
                                                                                                    <HeaderStyle Wrap="False"  />
                                                                                                    <ItemStyle Wrap="False"  />
                                                                                                </asp:BoundField>
                                                                                                <asp:BoundField DataField="StepSort" HeaderText="Step Sort">
                                                                                                    <HeaderStyle Wrap="False"  />
                                                                                                    <ItemStyle Wrap="False"  />
                                                                                                </asp:BoundField>
                                                                ...
                                                                <Triggers>
                                                                    <asp:AsyncPostBackTrigger ControlID="btnAddDocStep" />
                                                                </Triggers>
                                                            </asp:UpdatePanel>
                                                        </div>
                                                    </div>
