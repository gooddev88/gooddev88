<%@ Page Title="User Group" Language="C#"  MasterPageFile="~/POS/SiteA.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="MyUserGroupDetail.aspx.cs" Inherits="Robot.Master.MyUserGroupDetail" %>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            ...
                                                            <asp:TextBox runat="server" ID="txtUserGroupId" ReadOnly="true" CssClass="form-control " />
                                                                        ...
                                                                        <asp:GridView ID="grdPermission"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Group Code">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="lblMenuGroup" runat="server" Text='<%# Bind("GroupID") %>'></asp:Label>
                                                                                    </ItemTemplate>
                                                                                    <HeaderStyle Wrap="false"  />
                                                                                    <ItemStyle Wrap="false"  />
                                                                                </asp:TemplateField>
                                                                                    ...
                                                                                    <div style="overflow-x: auto; width: 100%">
                                                                                        <asp:GridView ID="grdGroupInDoc" runat="server" AutoGenerateColumns="False" Width="100%"
                                                                                            ...
                                                                                            <Columns>
                                                                                                ...
                                                                                                <asp:TemplateField ShowHeader="true" HeaderStyle-Width="80px">
                                                                                                    <ItemTemplate>
