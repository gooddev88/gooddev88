<%@ Page Title="Vendor info" Language="C#" MasterPageFile="~/POS/SiteA.Master" AutoEventWireup="true" CodeBehind="VendorDetail.aspx.cs" ClientIDMode="Static" Inherits="Robot.Master.VendorDetail" %>
                                        ...
                                        <div class="col-md-12 pl-1 pr-0">
                                            <div class="card">
                                                <div class="card-header pt-2 pb-1">
                                                    <div class="row">
                                                        <div class="col-md-8"><i class="fas fa-user-circle fa-2x"></i>&nbsp<span >Vender Info</span></div>
                                                        <div class="col-md-4 pt-1 text-right">
                                                            <span style="font-size: large;">
                                                                <asp:CheckBox ID="chkIsParner"  Text="Partner" runat="server" />
                                                    ...
                                                    <div class="row ">
                                                        <div class="col-md-8">
                                                            <div class="row " style="font-size: small;">
                                                                <div class="col-md-6">
                                                                    <span>รหัสผู้ขาย</span>
                                                                    <asp:TextBox ID="txtVenderID" CssClass="form-control form-control-sm" runat="server" placeholder="++NEW++"></asp:TextBox>
                                                                </div>
                                                                <div class="col-md-6">
                                                            ...
                                                            <div class="row pt-2 " style="font-size: small;">
                                                                <div class="col-md-2 " hidden="hidden">
                                                                    <span>คำนําหน้า</span><span style="font-size: large; color: red">*</span>
                                                                    <asp:DropDownList ID="cboTitleTh" runat="server" CssClass="form-control form-control-sm" DataTextField="Description1" DataValueField="ValueTXT"></asp:DropDownList>
                                                                </div>
                                                                <div class="col-md-6">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body pt-1 pb-2">
                                                    <asp:UpdatePanel ID="udpAddrCustomer" UpdateMode="Conditional" runat="server">
                                                        <ContentTemplate>
                                                            <div class="row " style="font-size: small;">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <dx:ASPxComboBox ID="cboVenAddr" runat="server"
                                                                        CssClass="Sarabun"
                                                                        AutoPostBack="true"
                                                                        ...
                                                                        DropDownWidth="600"
                                                                        DropDownHeight="300"
                                                                        OnSelectedIndexChanged="cboVenAddr_SelectedIndexChanged"
                                                                        ValueType="System.String" ValueField="ID"
                                                                        OnItemsRequestedByFilterCondition="cboVenAddr_OnItemsRequestedByFilterCondition_SQL"
                                                                        OnItemRequestedByValue="cboVenAddr_OnItemRequestedByValue_SQL" TextFormatString="{0}"
                                                        ...
                                                        <Triggers>
                                                            <asp:AsyncPostBackTrigger ControlID="cboVenAddr" />
                                                        </Triggers>
                                                    </asp:UpdatePanel>
                                                    <div class="row " style="font-size: small;">
                                                        <div class="col-md-6">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row pb-1">
                                                                <div class="col-md-2 ">
                                                                    ...
                                                                    <dx:ASPxComboBox ID="cboCreditTerm" runat="server"
                                                                        Theme="Material"
                                                                        CssClass="Sarabun"
                                                                        DropDownStyle="DropDownList"
                                                                        ValueField="TermID"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <dx:ListBoxColumn FieldName="TermDesc" Width="180px" Caption="Description" />
                                                                        </Columns>
                                                                    </dx:ASPxComboBox>
                                                                </div>
                                                                ...
                                                                <div class="col-md-2 ">
                                                                    <span style="font-size: small">Credit Limit</span>
                                                                    <asp:TextBox ID="txtCreditLimit" Font-Size="Small"
                                                                        onkeypress="return DigitOnly(this,event)"
                                                                        CssClass="form-control form-control-sm" runat="server"></asp:TextBox>
                                                                </div>
                                                                <div class="col-md-2 " runat="server" hidden="hidden">
                                                                    <span style="font-size: smaller">Currency</span>
                                                                    <dx:ASPxComboBox ID="cboCurrency" runat="server"
                                                                        ...
                                                                        ValueType="System.String" ViewStateMode="Enabled" TextFormatString="{0}" Width="100%">
                                                                        <Columns>
                                                                ...
                                                                <div class="col-md-2 ">
                                                                    ...
                                                                    <dx:ASPxComboBox ID="cboVatType" runat="server"
                                                                        Theme="Material"
                                                                        DropDownStyle="DropDownList"
                                                                        ValueField="TaxID" ValueType="System.String"
                                                                        ViewStateMode="Enabled" TextFormatString="{0}" Width="100%">
                                                                        <Columns>
