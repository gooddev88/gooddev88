<%@ Page Title="" Language="C#" MasterPageFile="~/Communication/SiteB.Master" AutoEventWireup="true" Async="true" CodeBehind="ChangeDate.aspx.cs" Inherits="Robot.Communication.Report.ChangeDate" %>
    ...
    <div class="row pt-2 kanit">
        <div class="col-xl-6 col-lg-8 col-md-12 col-sm-12 col-12 mx-auto">
            <div class="row">
                    ...
                    <dx:ASPxCalendar ID="dtChangeDate" Width="100%" Theme="Material" runat="server" />
                </div>
            </div>
