<%@ Page Title="Line Login Request" Language="C#" EnableEventValidation="false"  MasterPageFile="~/Communication/SiteA.Master"  AutoEventWireup="true" CodeBehind="LineLogInRequestList.aspx.cs" Inherits="Robot.Communication.Line.LineLogInRequestList" %>
    ...
    <div class="row">
                            ...
                            <dx:ASPxGridView ID="grdDetail" runat="server"
                                ...
                                <Columns>
                                    <dx:GridViewDataTextColumn Width="60">
                                        <DataItemTemplate>
                                            <asp:LinkButton ID="btnApprove" runat="server" CssClass="btn btn-icons btn-default"
                                                CommandName="app" CommandArgument='<%# Eval("ReqID") %>'>
                                        ...
                                        <DataItemTemplate>
                                            <asp:LinkButton ID="btnOpen" runat="server" CssClass="btn btn-icons btn-default"
                                                CommandName="sel" CommandArgument='<%# Eval("ReqID") %>'>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="ชื่อ-นามสกุล" FieldName="UserFullName" Width="200">
                                        <Settings AutoFilterCondition="Contains" />
                                        <HeaderStyle  Wrap="False" />
                                        <CellStyle  Wrap="False" />
                                    </dx:GridViewDataTextColumn>
      ...
      <%--<dx:GridViewDataTextColumn Caption="Cost Name" FieldName="UserCompanyName" Width="200">
                                        ...
                                        <CellStyle  Wrap="False" />
                                                ...
                                                <dx:GridViewDataTextColumn Caption="Status" FieldName="ActionStatus" Width="120">
                                        <Settings AutoFilterCondition="Contains" />
                                        <HeaderStyle  Wrap="False" />
                                        <CellStyle  Wrap="False" />
                                    </dx:GridViewDataTextColumn>
                                   ...
                                   <dx:GridViewDataTextColumn Caption="Approve Memo" FieldName="ActionMemo" Width="120">
                                        <Settings AutoFilterCondition="Contains" />
                                        <HeaderStyle  Wrap="False" />
                                        <CellStyle  Wrap="False" />
                                    </dx:GridViewDataTextColumn>
 
                                    <dx:GridViewDataDateColumn Caption="Request date" FieldName="RequestDate" Width="120">
                                        <HeaderStyle  Wrap="False" />
                                        <CellStyle  Wrap="False" />
                                        <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy"></PropertiesDateEdit>
                                    </dx:GridViewDataDateColumn>
                                       <dx:GridViewDataTextColumn Caption="Action Memo" FieldName="ActionMemo" Width="120">
                                        <Settings AutoFilterCondition="Contains" />
                                        <HeaderStyle  Wrap="False" />
                                        <CellStyle  Wrap="False" />
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Request memo" FieldName="ReqMemo" Width="100%">
                                        <Settings AutoFilterCondition="Contains" />
                                        <HeaderStyle  Wrap="False" />
                                        <CellStyle  Wrap="False" />
                                    </dx:GridViewDataTextColumn>
