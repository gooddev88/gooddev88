<%@ Page Title="ยืนยันลงทะเบียน Line" Language="C#" MasterPageFile="~/Communication/SiteA.Master" AutoEventWireup="true" CodeBehind="LineLogInDetail.aspx.cs" ClientIDMode="Static" Inherits="Robot.Communication.Line.LineLogInDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row pt-4">
        <div class="col-8 mx-auto">
           ...
           <asp:Literal ID="lblRequestMeomo" runat="server"></asp:Literal>
                </div>
            </div>
            <hr />
     ...
     <div class="row text-center pt-1">
               <div class="col-12  ">
                    <asp:Button ID="btnBack"
                        CssClass="btn btn-default " ForeColor="#3366ff" Width="150" runat="server" Text="กลับ" OnClick="btnBack_Click"   />
                   
                    <asp:Button ID="btnDelete"
                        CssClass="btn btn-default " ForeColor="#ff3399" Width="150" runat="server" Text="ลบการผูกบัญชี"  OnClick="btnDelete_Click"/>
