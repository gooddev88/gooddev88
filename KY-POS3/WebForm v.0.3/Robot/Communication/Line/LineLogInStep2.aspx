<%@ Page Title="ลงทะเบียนใช้งาน" Language="C#" MasterPageFile="~/Communication/SiteB.Master" AutoEventWireup="true" CodeBehind="LineLogInStep2.aspx.cs" ClientIDMode="Static" Inherits="Robot.Communication.Line.LineLogInStep2" %>
        ...
        <div class="col-12 mx-auto">
            <div class="row text-center">
                <div class="col-12">
                    ...
                    <br />
                    <asp:Label ID="lblUser" runat="server" Font-Size="Medium"> </asp:Label>
                    <br />
                    <asp:Label ID="lblDescription" runat="server" Font-Size="Medium"> </asp:Label>
                </div>
            </div>
            <hr />
            ...
            <div class="row pt-2 ">
                <div class="col-md-12">
                    <span style="font: large">มีอะไรฝากบอกแอดมินเขียนได้เลย...</span>
            ...
            <div class="row pt-2">
                <div class="col-10 text-right ">
                    <asp:Button ID="btnOk"
                        CssClass="btn btn-default " ForeColor="#9966ff" 
                          OnClientClick="this.disabled='true';"
                          UseSubmitBehavior="false"
                        runat="server" Text="ส่งคำขอเดี๋ยวนี้เลย" OnClick="btnOk_Click" />                           
                </div>
            </div>
