<%@ Page Title="Create new" Language="C#" MasterPageFile="~/POS/SiteA.Master" ClientIDMode="AutoID" AutoEventWireup="true" CodeBehind="POSPONewDoc.aspx.cs" Inherits="Robot.POS.POSPONewDoc" %>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row pt-2 ">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-10" id="divsearch" runat="server">
                                            ...
                                            <div class="col-md-2 pt-1">
                                                <asp:LinkButton ID="btnSearch" CssClass="btn btn-success bn-lg" Width="100%" runat="server" Text="ค้นหา" OnClick="btnSearch_Click"></asp:LinkButton>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                                ...
                                                                <asp:LinkButton runat="server" CommandName="ok" CommandArgument='<%# Eval("CompanyID")%>' class="btn p-0" ID="btnCompanyID" Width="100%">
                                                                    <div class="row">
                                                                        <div class="col-md-12 text-left">
                                                                            <strong>
                                                                                <asp:Label runat="server" Font-Size="Large" ID="lblCustomerID" Text='<%# Eval("CompanyID") %>'></asp:Label>
                                                                            </strong>
                                                                        </div>
                                                                 
                                                                        <div class="col-md-12 text-left">
                                                                            <asp:Label runat="server" ForeColor="Gray" Font-Size="Large" Text='<%# Eval("Name1")  %>'></asp:Label>
                                                                        </div>
                                                                    </div>
                                                                </asp:LinkButton>
