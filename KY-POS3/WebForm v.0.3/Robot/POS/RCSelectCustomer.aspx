<%@ Page Title="Create new" Language="C#"  MasterPageFile="~/POS/SiteA.Master" AutoEventWireup="true" CodeBehind="RCSelectCustomer.aspx.cs" ClientIDMode="Static" Inherits="Robot.POS.RCSelectCustomer" %>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 pt-2 text-center">
                            <%--<span style="color: black"><i class="fas fa-baby fa-2x"></i></span>--%>
                            <span style="font-size: x-large">เปิดให้กับ ลูกค้า</span>
                        </div>
                        ...
                        <div class="card-header">
                          <%--  <div class="row ">
                                <div class="col-md-12 pt-1 "> 
                                    <asp:DropDownList ID="cboCompany" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cboCompany_SelectedIndexChanged"
                                        CssClass="form-control" DataTextField="Name" DataValueField="CompanyID"></asp:DropDownList>
                                </div>
                            </div>--%>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-9" id="divsearch" runat="server">
                                            <dx:ASPxTextBox ID="txtSearch" placeholder="ค้นหาชื่อลูกค้า หรือ รหัสลูกค้า" runat="server" CssClass="form-control form-control-lg" Width="100%"></dx:ASPxTextBox>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card bg-light">
                                            <div class="card-body" >
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <asp:LinkButton runat="server" CommandName="Confirm" CommandArgument='<%# Eval("CustomerID")%>' CssClass="btn btn-default" ID="btnCusID" Width="100%">
                                                            <div class="row">
                                                                <div class="col-12 text-left">
                                                              รหัส   &nbsp<span  style="font-size:larger"><%# Eval("CustomerID")  %></span>
                                                                    <br />
                                                                     ชื่อ &nbsp<span  style="font-size:larger"><%# Eval("FullNameTh")  %></span>                                                                     
                                                                </div>       
                                                            </div>
                                                        </asp:LinkButton>
                                                        <asp:Label Visible="false" runat="server" ID="lblCusID" Text='<%# Eval("CustomerID") %>'></asp:Label>
                                                        <asp:Label Visible="false" runat="server"  ID="lblCompany" Text='<%# Eval("CompanyID") %>'></asp:Label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
