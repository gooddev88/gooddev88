...
namespace Robot.Data.DA
{
    public class XFilesService
    {
     ...
     //   private readonly IHostingEnvironment _host;
        ...
        public static XUploadInfo NewTemplateUploadCompanyProfile(string rcom, string comid, string fullname, string createdBy) {
            var u = NewXUploadInfo(rcom, createdBy);
        ...
        public static XUploadInfo NewTemplateUploadItemsProfile(string rcom, string docid, string fullname, string createdBy) {
            var u = NewXUploadInfo(rcom, createdBy);
        ...
        [Obsolete]
        public static  I_BasicResult ConvertByte2File(string rcom,string docId, string type) {
            I_BasicResult result = new I_BasicResult { Result = "ok", Message1 = "", Message2 = "" };
            try {
                ...
                using (GAEntities db = new GAEntities()) {
                    ...
                    fileRef = db.vw_XFilesRef.Where(o => (o.DocID == docId || docId == "")
                                                                      && o.DocType == type
                                                                      && o.RCompanyID == rcom
                                                     ).ToList();
                    ...
                    foreach (var r in fileRef) {
                      ...
                      //  string contentRootPath = _host.ContentRootPath;
                       ...
                       // string webRootPath = _host.WebRootPath;
                        ...
                        string pathOriginal = Path.Combine(@"D:\", "ImageStorage","KYPOS",r.RCompanyID, type);
                        string pathThumb = Path.Combine(@"D:\", "ImageStorage", "KYPOS", r.RCompanyID, type, "Thumb");

                  
                        if (!Directory.Exists(pathOriginal)) {  //Check if directory exist
