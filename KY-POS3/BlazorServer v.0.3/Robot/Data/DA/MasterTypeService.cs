    ...
    public class MasterTypeService {
        ...
        public I_MasterTypeSet GetDocSet(string docid, string rcom,string valuetxt)
        {
            ...
            using (GAEntities db = new GAEntities())
            {
                ...
                //if (n.Line.Count == 0) {
                //    n.LineActive = new MasterTypeLine { Description1 = "", Description2 = "", Description3 = "", Description4 = "NEW", ValueTXT = "", MasterTypeID = "", IsActive = true, ParentID = "", Sort = 1, RComID = "", RefID = "", ParentValue = "" };
                //} else {
