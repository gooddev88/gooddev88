...
namespace PrintMaster.PrintFile.Accy.INV101 {
    public class RunReportINV {
        //INV101 ใบกำกับภาษี


        public static INV101 OpenReport(PrintData print_row,string typeprint) {
            var doc = JsonConvert.DeserializeObject<INV101Set>(print_row.JsonData);
            ...
            if (typeprint == "INV101")
            {
                INV101 report0 = new INV101(doc, "ลูกค้า", typeprint, "0","");
                report0.DisplayName = doc.head.INVID;
                report0.CreateDocument();
                INV101 report1 = new INV101(doc, "ลูกค้า", typeprint, "1", "");
                report1.CreateDocument();
                report0.Pages.AddRange(report1.Pages);
                INV101 report2 = new INV101(doc, "บัญชี", typeprint, "1", "");
                report2.CreateDocument();
                report0.Pages.AddRange(report2.Pages);
                INV101 report3 = new INV101(doc, "การเงิน", typeprint, "1", "");
                report3.CreateDocument();
                report0.Pages.AddRange(report3.Pages);

                report = report0;
            } else if (typeprint == "INV101_1") {//ขายเงินสด
                INV101 report0 = new INV101(doc, "ลูกค้า", typeprint, "0", "");
                report0.DisplayName = doc.head.INVID;
                report0.CreateDocument();
                INV101 report1 = new INV101(doc, "ลูกค้า", typeprint, "1", "");
            ...
            {
                INV101 report0 = new INV101(doc, "", typeprint, "0", "");
                report0.DisplayName = doc.head.INVID;
                report0.CreateDocument();
                INV101 report1 = new INV101(doc, "", typeprint, "1", "");
                report1.CreateDocument();
                report0.Pages.AddRange(report1.Pages);
                report = report0;
            }
