...
namespace Robot.PrintFile.KyPos.R40X {
    public partial class R412 : DevExpress.XtraReports.UI.XtraReport {
        
        public I_POSSaleSetX x { get; set; }
        public R412(I_POSSaleSetX _x) {
            x = _x;
            InitializeComponent();
            initData();
        }
        ...
        public void initData() {
            ...
            var payment_transfer = x.Payment.Where(o => o.BillID == h.BillID && o.PaymentType == "TRANSFER" && o.IsActive == true).FirstOrDefault();
            h = CalHead(x.Head);
        ...
        .Select(g =>
            ...
            //lblTotalAmtIncVat.Text = (Math.Round(sumline.Sum(o => o.TotalAmt), 2, MidpointRounding.AwayFromZero)).ToString("N2");
